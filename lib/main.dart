...
import 'package:flutter_drive_filer/Onboarding/dot_indicators.dart';
import 'package:flutter_drive_filer/Onboarding/page.dart';
              ...
              child: new SafeArea(
                child: AppBar(
                  ...
                  title: Row(
                    ...
                    children: <Widget>[
                      FlatButton(
                        child: Text(page >= 1 ? 'BACK' : '', style: TextStyle(color: Colors.white),),
                        onPressed:(){
                          if(page >= 1){
